 ...
 */
public class FmblSinkConnector extends SinkConnector {

    public static final String FILE_CONFIG = "file";
    
    public static final String FMBL_FOLDER = "fmblfolder";
    
    private static final ConfigDef CONFIG_DEF = new ConfigDef()
    		.define(FILE_CONFIG, Type.STRING, null, Importance.HIGH, "Destination filename")
    		.define(FMBL_FOLDER, Type.STRING, null, Importance.HIGH, "Destination folder of fmbl files");
    ...
    public void start(Map<String, String> props) {
        ...
        fmblFolder = parsedConfig.getString(FMBL_FOLDER);
    }

    @Override
    public Class<? extends Task> taskClass() {
        return FmblSinkTask.class;
    }
    ...
    public List<Map<String, String>> taskConfigs(int maxTasks) {
        ...
        for (int i = 0; i < maxTasks; i++) {
            ...
            config.put(FMBL_FOLDER, fmblFolder);
